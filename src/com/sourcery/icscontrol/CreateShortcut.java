...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.sourcery.icscontrol.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), ICSControlActivity.class);
        shortcutIntent.setAction("com.sourcery.icscontrol.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("sourcery_fragment_name", intentClass);
    ...
    private int getProperShortcutIcon(String className) {
        ...
        if (c.equals("Lockscreens"))
            ...
            return R.drawable.ic_ics_control_power_menu;
        else if (c.equals("StatusBarBattery"))
            return R.drawable.ic_ics_control_battery;
        else if (c.equals("StatusBarClock"))
            return R.drawable.ic_ics_control_clock;
        else if (c.equals("StatusBarGeneral"))
            return R.drawable.ic_ics_control_general;
        else if (c.equals("StatusBarToggles"))
            return R.drawable.ic_ics_control_toggles;
        else if (c.equals("UserInterface"))
            return R.drawable.ic_ics_control_general_ui;
        else
